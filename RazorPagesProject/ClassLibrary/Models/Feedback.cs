...
namespace ClassLibrary.Models
{
    public  class Feedback
    {
        ...
        public Feedback(string first_name_contact,string last_name_contact,string school_contact,string email_contact,string subject_contact)
        {
        ...
        public Feedback(int id_ticket,string first_name_contact, string last_name_contact, string school_contact, string email_contact, string subject_contact)
        {
            this.id_ticket = id_ticket;
            this.first_name_contact = first_name_contact;
            this.last_name_contact = last_name_contact;
